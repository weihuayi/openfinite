...
//typedef OF::GeometryModel::CubeWithSpheresModelHexMesh<GK> Model;
//typedef OF::GeometryModel::C6H6<GK> Model;
typedef OF::GeometryModel::C6<GK> Model;
typedef GK::Point_3 Node;
typedef GK::Vector_3 Vector;
typedef OF::Mesh::HexahedronMesh<GK, Node, Vector> HexMesh;
typedef OF::Mesh::ParallelMesh<GK, HexMesh> PMesh;
//typedef OF::Mesh::HexJacobiQuality<PMesh> CellQuality;
typedef OF::Mesh::HexPositiveJacobiQuality<PMesh> CellQuality;
...
//typedef OF::Mesh::MixNodePatchObjectFunction<PMesh, CellQuality> ObjectFunction;
