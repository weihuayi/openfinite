...
typedef OF::Mesh::ParallelMesh<GK, QMesh> PMesh;
//typedef OF::Mesh::QuadJacobiQuality<PMesh> CellQuality;
typedef OF::Mesh::QuadPositiveJacobiQuality<PMesh> CellQuality;
